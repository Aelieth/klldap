...
**Checklist**
- [ ] Check if there is already an [example config](https://github.com/Aelieth/klldap/tree/main/example_configs) for it (upstream LLDAP's configs apply to KLLDAP unchanged).
